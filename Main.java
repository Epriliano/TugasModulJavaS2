...
public class Main {
    ...
    private static final Scanner scanner = new Scanner(System.in); // Pindahkan Scanner ke level main

    public static void main(String[] args) {
        books.add(new Book("1012", "Surga itu baik", "Jhon", "Religi", 3)); 
        books.add(new Book("1013", "Ketinggian Tak selamanya Indah", "Musa", "Petualangan", 2)); 
        books.add(new Book("1014", "Habis Akrab Terbitlah Asing", "Madam", "Romance", 1));
    ...
    public static void loginAsAdmin() {
        ...
        switch (userInput) {
            case 1 -> addStudent();
            case 2 -> displayRegisteredStudents();
            case 3 -> System.out.println("Keluar dari akun admin...");
            default -> System.out.println("Input tidak valid. Silakan coba lagi.");
        }
    }
